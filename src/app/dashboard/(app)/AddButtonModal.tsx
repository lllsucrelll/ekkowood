...
export function AddButtonModal({ onClose }: { onClose: () => void }) {
  ...
  return (
    <Modal onClose={onClose} title="Ajouter un bouton">
      <form action={formAction} className="flex flex-col gap-4">
        <div className="flex flex-col gap-1">
          <label htmlFor="add-type" className="text-xs font-medium text-brand-text/70">
            Type
          </label>
          <select
            id="add-type"
        ...
        <div className="flex flex-col gap-1">
          <label htmlFor="add-label" className="text-xs font-medium text-brand-text/70">
        ...
        {useGooglePicker ? (
          ...
          <div className="flex flex-col gap-1">
            <label htmlFor="add-url" className="text-xs font-medium text-brand-text/70">
